.PHONY: help tests black isort docstrings format mypy qc actions
default: help

MAIN_PACKAGE_DIRECTORY="package_checker"
PYTHON_SRC_DIRECTORIES=${MAIN_PACKAGE_DIRECTORY} "tests" "scripts"
...
actions: # Generate the action.yaml file
